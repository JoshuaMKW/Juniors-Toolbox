...
class BTPFacialEntry():
    def __init__(self, mat_name="BTPFacialEntry", frames=0):
        self.name = mat_name
        self.frames = frames
...
class BTP(BasicAnimation):
    ...
    def __init__(self, flag=0, unknown1=1):
        self.animations = []
        self.flag = flag
    ...
    def from_bytes(cls, data: BinaryIO, *args: VariadicArgs, **kwargs: VariadicKwargs):
        ...
        # also known as "keyframe count in the documentation"
    ...
    def get_loading_information(self):
        ...
        information.append(
            ["Loop Mode: ", self.flag, "Maximum Duration:", self.unknown_address])
        ...
        for anim in self.animations:
            ...
            # j is the index within each mat frame list
            for j in range(len(list_of_frames)):
    ...
    def empty_table(cls, created):
        ...
        information.append(
            ["Flag / Loop Mode: ", 0, "Maximum Duration:", int(created[3])])
