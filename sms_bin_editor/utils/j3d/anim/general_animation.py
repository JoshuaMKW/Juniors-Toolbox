...
def convert_to_a(filepath, info):
    from sms_bin_editor.utils.j3d.anim.bla import bla
    from sms_bin_editor.utils.j3d.anim.blk import blk
    from sms_bin_editor.utils.j3d.anim.bca import bca
    from sms_bin_editor.utils.j3d.anim.bck import BCK
...
def sort_file(filepath):
    from sms_bin_editor.utils.j3d.anim.bva import BVA
    from sms_bin_editor.utils.j3d.anim.bla import bla
    from sms_bin_editor.utils.j3d.anim.blk import blk
    from sms_bin_editor.utils.j3d.anim.bca import bca
    from sms_bin_editor.utils.j3d.anim.bck import BCK
    from sms_bin_editor.utils.j3d.anim.bpk import bpk
    from sms_bin_editor.utils.j3d.anim.brk import BRK
    from sms_bin_editor.utils.j3d.anim.btk import BTK
    from sms_bin_editor.utils.j3d.anim.btp import btp
